 ...
 */
package com.tools.cchttp.log;




import com.tools.cchttp.log.help.CharacterHandler;
import com.tools.cchttp.log.help.UrlEncoderUtils;
import com.tools.cchttp.log.help.ZipHelper;
...
public class RequestInterceptor implements Interceptor {
    ...
    //打印请求信息
    boolean logRequestCc =true;
    //打印响应信息
    boolean logResponseCc =true;
...
//    GlobalHttpHandler mHandler;
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        boolean logRequest =   logRequestCc;
        ...
        boolean logResponse = logResponseCc;
